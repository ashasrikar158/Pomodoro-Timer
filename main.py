...
title_text=Label(text="Timer",fg=GREEN, font=(FONT_NAME,20,"bold"))
...
tick_text=Label(text="",fg=GREEN, bg=YELLOW,font=(FONT_NAME,20,"bold"))
tick_text.grid(column=1,row=4)
